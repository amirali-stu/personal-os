...
import { GripVertical, Link2, Music2, Pause, Play, Trash2 } from "lucide-react";
...
export function TrackRow({ track, tracks, onDelete, showDragHandle }: Props) {
  ...
  return (
    ...
    >
      {showDragHandle && (
        <span className="cursor-grab text-[var(--color-text-muted)] opacity-40 transition hover:opacity-100 active:cursor-grabbing">
