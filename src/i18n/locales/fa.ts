const fa = {
  ...
  tasks: {
    ...
    added: "کار اضافه شد",
    deleted: "کار حذف شد",
    allDone: "آفرین! همه کارهای امروز انجام شد 🎉",
    priority: "اولویت",
    priorities: {
      low: "کم",
      medium: "متوسط",
    ...
    tagsPlaceholder: "تگ‌ها (با کاما جدا کن)",
    export: "خروجی",
    import: "ورودی",
    exportSuccess: "فایل تسک‌ها دانلود شد",
    exportError: "خطا در خروجی گرفتن",
    importSuccess: "{{count}} تسک وارد شد",
  ...
  command: {
    placeholder: "جستجو یا دستور را بنویس...",
    empty: "نتیجه‌ای پیدا نشد",
    hint: "Ctrl+K برای باز کردن",
    navigate: "جابجایی",
    newTask: "کار جدید",
  },
} as const;
